...
* Altercation :drill:
Altercation - . - an extreme, powerful fight or disagrement, known to the public.
...
* Heirloom :drill:
Heirloom - . - something of special value handed down from older generations.
...
* Vitrol :drill:
Vitrol - . - bitter criticism.

* Jovial :drill:
Jovial - . - cheerful, friendly.

* Steelmanning :drill:
A steel man argument - . - constructing the strongest form of opponent argument. So it producces the best argument to the core of opponent position. This may involve removed flawed assumptions that could be easilly refuted.

* Argumentum ad populum :drill:
Argumentum ad populum - . - fallacious argument based on affirming something is real because majority thinks so.

* Unconscionable :drill:
Unconscionable - . - амморально непренципный чрезмерный.
